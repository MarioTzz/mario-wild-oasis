...
function CheckinBooking() {
  ...
  if (isLoading || !booking || isSettingsLoading) return <Spinner />;
  ...
  return (
    <>
      ...
      {!hasBreakfast && !isSettingsLoading && (
        <Box>
          <Checkbox
      ...
      <Box>
        ...
        >
          I confirm that {guests.fullName} have paid for this booking of {formatCurrency(totalPrice + (addBreakfast ? optionalBreakfastPrice : 0))}
        </Checkbox>
      </Box>
      <ButtonGroup>
